...
export const newplugin271_get__read = () => ({
  type: types.NEWPLUGIN271_GET__READ
})
export const newplugin271_get__readSucceeded = response => ({
  type: types.NEWPLUGIN271_GET__READ_SUCCEEDED,
  response
})
export const newplugin271_get__readFailed = error => ({
  type: types.NEWPLUGIN271_GET__READ_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_list = () => ({
  type: types.API_V1_GHGJFJHGFJHF_LIST
})
export const api_v1_ghgjfjhgfjhf_listSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_LIST_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_listFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_LIST_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_create = () => ({
  type: types.API_V1_GHGJFJHGFJHF_CREATE
})
export const api_v1_ghgjfjhgfjhf_createSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_CREATE_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_createFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_CREATE_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_read = () => ({
  type: types.API_V1_GHGJFJHGFJHF_READ
})
export const api_v1_ghgjfjhgfjhf_readSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_READ_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_readFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_READ_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_update = () => ({
  type: types.API_V1_GHGJFJHGFJHF_UPDATE
})
export const api_v1_ghgjfjhgfjhf_updateSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_UPDATE_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_updateFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_UPDATE_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_partial_update = () => ({
  type: types.API_V1_GHGJFJHGFJHF_PARTIAL_UPDATE
})
export const api_v1_ghgjfjhgfjhf_partial_updateSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_partial_updateFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_ghgjfjhgfjhf_delete = () => ({
  type: types.API_V1_GHGJFJHGFJHF_DELETE
})
export const api_v1_ghgjfjhgfjhf_deleteSucceeded = response => ({
  type: types.API_V1_GHGJFJHGFJHF_DELETE_SUCCEEDED,
  response
})
export const api_v1_ghgjfjhgfjhf_deleteFailed = error => ({
  type: types.API_V1_GHGJFJHGFJHF_DELETE_FAILED,
  error
})
